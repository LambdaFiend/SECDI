...
alex_table = Data.Array.listArray (0 :: Int, 4784)
  [ 0
  , 40
  , 40
  , 40
...
alex_check = Data.Array.listArray (0 :: Int, 4784)
  [ -1
  , 0
  , 1
  , 2
...
alex_action_30 = \pos _ -> Token pos UNDERSCORE
alex_action_31 = \pos _ -> Token pos LAMBDA
alex_action_32 = \pos _ -> Token pos DOT
alex_action_33 = \pos _ -> Token pos LPAREN
alex_action_34 = \pos _ -> Token pos RPAREN
alex_action_35 = \pos s -> Token pos (ID s)
alex_action_36 = \pos s -> Token pos (LITINT (read s))
alex_action_37 = \pos s -> Token pos (ERROR ("Lexing error: " ++ s))
